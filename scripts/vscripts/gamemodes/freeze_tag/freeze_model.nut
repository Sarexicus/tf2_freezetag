...
::frozen_player_model_root <- null;
::frozen_player_model_suffix <- null;
::single_frozen_player_model <- "models/freezetag/player/ft_hologram.mdl";
::extra_prop_model <- "models/props_mvm/hologram_projector.mdl";
::model_scale <- 1.3;
::extra_prop_model_scale <- 0.5;

::transfer_sequence <- false;
::transfer_pose <- false;
::transfer_cosmetics <- false;
...
::statue_color <- { [TF_TEAM_BLUE] = "225 255 255", [TF_TEAM_RED] = "255 225 255" };        // this is the color that will tint the frozen player models
